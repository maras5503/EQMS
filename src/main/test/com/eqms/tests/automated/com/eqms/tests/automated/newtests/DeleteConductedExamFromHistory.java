...
import java.net.URL;
public class DeleteConductedExamFromHistory {
    ...
    @Test
    public void deleteConductedExamFromHistoryTest() throws Exception{
        ...
        Thread.sleep(1000);
        driver.findElement(By.id("deleteConductedExamBtn")).click();
        Thread.sleep(1000);
        driver.findElement(By.id("confirmDeleteConductedExamBtnModal")).click();
        Thread.sleep(1000);
        try {
