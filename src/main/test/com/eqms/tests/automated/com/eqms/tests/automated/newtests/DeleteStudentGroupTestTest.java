...
import java.net.URL;
public class DeleteStudentGroupTestTest {
  ...
  @Test
  public void deleteStudentGroupTest() throws Exception {
    ...
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#deleteStudentGroupBtn")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("confirmDeleteStudentGroupBtnModal")).click();
    Thread.sleep(3000);
    driver.findElement(By.cssSelector("#studentgroups_table_filter .form-control")).click();
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#studentgroups_table_filter .form-control")).sendKeys("Test Group");
    Thread.sleep(1000);
    try {
