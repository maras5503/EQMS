...
import java.net.URL;
public class EditStudentGroupTestTest {
  ...
  @Test
  public void editStudentGroupTest() throws Exception {
    ...
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#editStudentGroupBtn")).click();
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#editStudentGroupFormModal #studentGroupNameModal")).click();
    Thread.sleep(1000);
    driver.findElement(By.cssSelector("#editStudentGroupFormModal #studentGroupNameModal")).sendKeys(" - edytowana");
    Thread.sleep(1000);
    driver.findElement(By.id("editStudentGroupBtnModal")).click();
    Thread.sleep(1000);
    try {
      assertEquals("Testowa grupa - edytowany", driver.findElement(By.cssSelector("td.sorting_1")).getText());
    } catch (Error e) {
